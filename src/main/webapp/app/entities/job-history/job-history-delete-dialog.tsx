...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterPlayApp.jobHistory.delete.question">
        <Translate contentKey="jhipsterPlayApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
