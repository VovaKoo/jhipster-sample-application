...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterPlayApp.department.delete.question">
        <Translate contentKey="jhipsterPlayApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
