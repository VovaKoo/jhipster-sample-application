  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterPlayApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="jhipsterPlayApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterPlayApp.employee.firstName')}
              ...
              <UncontrolledTooltip target="firstNameLabel">
                <Translate contentKey="jhipsterPlayApp.employee.help.firstName" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('jhipsterPlayApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterPlayApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterPlayApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterPlayApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterPlayApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterPlayApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('jhipsterPlayApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterPlayApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
